        ...
        <div className=''>
            <div className="product-container">
                <div className="text-container">
                    <h1 className='text-5xl'>World most usefull Device</h1>
                    <h1 className='text-5xl'>World most usefull Device</h1>
                    ...
                    <button className='rounded-lg bg-sky-300 text-3xl p-4 text-white '>Demo</button>
                </div>
            ...
            <section className='reviews-section grid justify-items-center'>
                <h2 className='text-2xl'>Customer Reviews (3)</h2>
                <Link to='reviews'>
                    <button className='bg-sky-200 rounded-lg text-xl px-4 py-1'>See all reviews</button>
                </Link>
            </section>
        </div>
    );
